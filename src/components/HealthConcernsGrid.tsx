      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="flex items-center justify-center mx-auto bg-[#c74a1b] dark:bg-blue-600 hover:bg-[#b8441a] dark:hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-full transition-colors duration-200"
          >
            {showAll ? (
              <>
