...
const CategoryPage: React.FC = () => {
  ...
  const categoryContent: Record<string, { title: string; description: string; content: string }> = {
    'mens-sexual-health': {
      ...
      content: 'Discover our comprehensive range of Ayurvedic products designed specifically for men\'s sexual wellness. Our formulations include powerful herbs like Ashwagandha, Shilajit, and Safed Musli that have been used for centuries to enhance male vitality, boost energy levels, and improve overall sexual health naturally.'
    },
    'womens-sexual-health': {
      title: "Women's Sexual Health", 
      description: 'Hormonal balance and feminine wellness solutions',
      content: 'Our women\'s health collection focuses on hormone support, menstrual balance, and overall reproductive wellness. Featuring time-tested ingredients like Shatavari and natural formulations that support feminine health, boost immunity, and promote hormonal harmony throughout different life stages.'
    },
    'erectile-dysfunction': {
      title: 'Erectile Dysfunction Solutions',
      description: 'Natural treatments for ED and performance enhancement',
      content: 'Address erectile dysfunction naturally with our specialized Ayurvedic formulations. Unlike synthetic medications, our natural treatments work to strengthen the root causes while promoting overall sexual wellness, nerve toning, and improved blood circulation without harmful side effects.'
    },
    'nightfall-pe': {
      title: 'Nightfall & Premature Ejaculation',
      description: 'Control and confidence enhancement treatments',
      content: 'Our specialized treatments for nightfall and premature ejaculation focus on nerve toning, reducing involuntary discharge, and building sexual confidence. These natural formulations help men gain better control while supporting overall reproductive health.'
    },
    'libido-boosters': {
      title: 'Libido Enhancement',
      description: 'Natural aphrodisiacs and desire enhancers',
      content: 'Reignite passion and desire with our collection of natural aphrodisiacs and libido boosters. These carefully crafted formulations use traditional herbs known for their ability to enhance sexual desire, improve mood, and boost overall sexual wellness for both men and women.'
    },
    'infertility-support': {
      title: 'Infertility Support',
      description: 'Reproductive health solutions for couples',
      content: 'Support your journey to parenthood with our reproductive health tonics designed for both partners. Our infertility support products combine ancient wisdom with modern understanding to promote reproductive wellness, improve fertility, and support conception naturally.'
    },
    'combos-kits': {
      title: 'Sexual Wellness Combos',
      description: 'Complete wellness packages for comprehensive care',
      content: 'Our combo packages offer comprehensive solutions that address multiple aspects of sexual wellness. These carefully curated bundles provide better value while ensuring you have everything needed for complete sexual health support and enhancement.'
    },
    'unani-homeopathy': {
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-black">
        ...
        <div className="container mx-auto px-4 py-8 text-center">
          <h1 className="text-2xl font-bold text-black dark:text-white mb-4">Category Not Found</h1>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Category Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-black dark:text-white mb-4">{currentCategory.title}</h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">{currentCategory.description}</p>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{currentCategory.content}</p>
          </div>
        </div>
