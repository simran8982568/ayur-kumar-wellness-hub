        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 sm:p-8 shadow-lg rounded-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">Complete your registration for {phoneNumber}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  I agree to the{' '}
                  <Link to="/policies" className="text-[#c74a1b] dark:text-blue-400 hover:underline">
                    Terms & Conditions
                  </Link>{' '}
                  and{' '}
                  <Link to="/policies" className="text-[#c74a1b] dark:text-blue-400 hover:underline">
